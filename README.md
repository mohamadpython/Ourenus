...
۱. **قالب رو با دستور زیر دانلود کنید**
   ```sh
   sudo wget -N -P /var/lib/marzban/templates/subscription/ https://github.com/mohamadpython/Ourenus/releases/latest/download/index.html
   ```
...
۱. **قالب رو با دستور زیر دانلود کنید**
   ```sh
   sudo wget -N -P /var/lib/marzneshin/templates/subscription/ https://github.com/mohamadpython/Ourenus/releases/latest/download/index.html
   ```
